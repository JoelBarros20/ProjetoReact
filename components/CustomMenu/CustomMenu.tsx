...
import styles from '@/app/styles/ComponentsStyles/CustomMenu/CustomMenu';
...
export default function CustomDrawer({ onClose }: CustomDrawerProps) {
    ...
    return (
        ...
        <View style={styles.drawer}>
            <TouchableOpacity onPress={() => { router.push('/homepage'); onClose(); }}>
                <Text style={styles.link}>Home</Text>
            </TouchableOpacity>
            <TouchableOpacity onPress={() => { router.push('//categories'); onClose(); }}>
                <Text style={styles.link}>Categorias</Text>
            </TouchableOpacity>
            {/* Adiciona mais links conforme necessário */}
