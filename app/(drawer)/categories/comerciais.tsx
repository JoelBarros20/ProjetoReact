    ...
    <View style={styles.ContainerMainPage}>
      ...
      <View style={styles.ContainerFilters}>
        ...
        <View style={{ width: 250, paddingHorizontal: 4 }}>
          <FlatList style={{}} data={transmissionOptions} keyExtractor={(item) => item.key} horizontal
      ...
      <View style={styles.ContainerSearchBar}>
        ...
        <Modal isVisible={isModalVisible} style={styles.ModalFilters} backdropTransitionInTiming={200} backdropTransitionOutTiming={200}
          onBackdropPress={() => { }}>
